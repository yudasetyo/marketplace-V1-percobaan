                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select name="provinces_id" id="provinces_id" class="form-control" v-if="provinces" v-model="province_id">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select name="regencies_id" id="regencies_id" class="form-control" v-if="regencies" v-model="regency_id">
